    ...
    public class Asset
    {
        ...
        public DataTable ViewAsset() 
        {
            ...
            try // try executing this block
            {
                ...
                string query = "SELECT A_ID, Name, Model, Manufacturer, Type, IP_Address, Purchase_Date, Text_Note, Employee_ID, S_ID, OSName, OSVersion, Software_Manufacturer, InstallationDate FROM Asset INNER JOIN SoftwareAsset ON Asset.S_ID = SoftwareAsset.OS_ID;";
        ...
        public void DeleteAsset(int id) {
            ...
            {
                //added placeholder so that it protect against sql injection attack, i learned this approach here "https://stackoverflow.com/questions/14376473/what-are-good-ways-to-prevent-sql-injection"
                string query = "DELETE from Asset where A_Id = @ID";
